...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "ring-muted flex flex-wrap gap-1 rounded-lg bg-background p-1 py-2 ring-1",
        {
...
>(({ className, children }, ref) => {
  return (
    <CommandList
      ref={ref}
      className={cn(
        "scrollbar-thin scrollbar-track-transparent scrollbar-thumb-muted-foreground dark:scrollbar-thumb-muted scrollbar-thumb-rounded-lg border-muted absolute top-0 z-10 flex w-full flex-col gap-2 rounded-md border bg-background p-2 shadow-md transition-colors",
        className,
      )}
    >
      {children}
