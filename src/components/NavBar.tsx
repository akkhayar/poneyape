...
const NavBar = () => {
  ...
  return (
    <>
      ...
      <nav className="px-6 md:px-16 h-[72px] justify-start border-b border-solid border-b-bg1 bg-[#ffffff66] flex items-center gap-10">
        <div className="flex gap-2">
          <button type="button" className="md:hidden" onClick={() => setShowMenuPage(true)}>
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
        ...
        <div className="absolute bg-white h-screen w-screen top-0 left-0 py-10 px-5 overflow-y-hidden" hidden={!showMenuPage}>
          <div className="pb-8 mb-8 border-b border-[#E5E5E0]">
            <a className="font-pyidaungsu text-[20px]">ပုံရိပ်</a>
            <button type="button" className="ms-10" onClick={() => setShowMenuPage(false)}>x</button>
          </div>
          <ul className="text-[#1B1B1B]">
            ...
            <li className="py-4 flex gap-4">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_507_1110)">
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
          ...
          <button className="primary w-full mt-6 md:hidden">REGISTER</button>
